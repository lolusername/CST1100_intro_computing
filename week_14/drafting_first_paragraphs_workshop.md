# Week 14 Drafting Workshop: Introduction + First Body Paragraph
...
2. Write 5–7 sentences that do the following:
   ...
   - Significance: who is affected and why it matters now.
   - Set the research question or tension you will address.
   - Working thesis: a specific, arguable claim you can support with your sources.  
3. Highlight or underline the thesis. Note any missing background facts you need to look up.
...
- Reviewer prompts:
  ...
  - Is the thesis easy to find and arguable? Mark unclear or overly broad language.
  - What context feels missing for a first-time reader?
...
## Submission checklist (end of class)
- MLA heading/header present; working title included.
- Intro paragraph with highlighted/underlined thesis.
- First body paragraph containing at least one MLA in-text citation.
- Peer review comment(s) visible in the document.
- File named `Lastname_Firstname_Week14_Draft.docx` or `.pdf` (keep an editable copy).

## Homework (due Week 15 peer share)
- Revise the intro and first body paragraph using peer feedback.
- Draft at least one additional body paragraph and a provisional Works Cited page.
- Finish an initial full draft to bring for next week’s peer share.
